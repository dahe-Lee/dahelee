...
const Ee = Object.getOwnPropertyDescriptors;
const ne = Object.getOwnPropertySymbols;
...
const ae = (i, e, t) =>
        e in i
            ...
            : (i[e] = t),
    W = (i, e) => {
        for (const t in e || (e = {})) Pe.call(e, t) && ae(i, t, e[t]);
        if (ne) for (const t of ne(e)) Me.call(e, t) && ae(i, t, e[t]);
        return i;
    },
    j = (i, e) => ye(i, Ee(e));
function le(i) {
            ...
            for (let r = 0, l = n.length; r < l; r += 1) {
                ...
                a !== void 0 &&
                    ...
                    ($(i[o]) && $(s[o])
                        ...
                        : !$(i[o]) && $(s[o])
                          ? ((i[o] = {}),
                            s[o].__swiper__ ? (i[o] = s[o]) : A(i[o], s[o]))
                          : (i[o] = s[o]));
            }
        }
    }
...
function O(i, e) {
    return (
        e === void 0 && (e = ""), [...i.children].filter((t) => t.matches(e))
    );
}
function R(i) {
    try {
        ...
        ? i[e === "width" ? "offsetWidth" : "offsetHeight"] +
              parseFloat(
                  s
                      ...
                      .getPropertyValue(
                          e === "width" ? "margin-right" : "margin-top",
                      ),
              ) +
              parseFloat(
                  s
...
function Fe(i) {
    ...
    return (
        !c &&
            ...
            c || (c = [0, 1, "13_0_0"]),
            (m = !1)),
        d && !f && ((l.os = "android"), (l.android = !0)),
        (c || p || u) && ((l.os = "ios"), (l.ios = !0)),
        l
    );
}
function Be(i) {
    return i === void 0 && (i = {}), U || (U = Fe(i)), U;
}
let J;
function Ne() {
    const i = z();
...
function Re(i) {
    ...
    const r = [],
        ...
        o = function (c, u) {
            ...
            f.observe(c, {
                attributes:
                    typeof u.attributes == "undefined" ? !0 : u.attributes,
                childList: typeof u.childList == "undefined" ? !0 : u.childList,
                characterData:
                    typeof u.characterData == "undefined"
                        ? !0
                        : u.characterData,
            }),
                r.push(f);
...
const He = {
    ...
    once(i, e, t) {
        ...
        function n() {
            ...
            for (
                const r = arguments.length, l = new Array(r), o = 0;
                o < r;
                o++
            )
                l[o] = arguments[o];
    ...
    emit() {
        ...
        let e, t, s;
        for (const n = arguments.length, r = new Array(n), l = 0; l < n; l++)
            r[l] = arguments[l];
        return (
...
function je() {
    ...
    typeof g == "string" && g.indexOf("%") >= 0
        ...
        t.centeredSlides &&
            t.cssMode &&
            (_(s, "--swiper-centered-offset-before", ""),
        ...
        if (
            ...
            if (t.slidesPerView === "auto") {
                ...
                (I = (r - (t.slidesPerView - 1) * g) / t.slidesPerView),
                    t.roundLengths && (I = Math.floor(I)),
                    c[S] &&
                        (c[S].style[i.getDirectionLabel("width")] = `${I}px`);
    ...
    if (a && t.loop) {
        ...
        if (t.slidesPerGroup > 1) {
            ...
            for (let b = 0; b < y; b += 1) p.push(p[p.length - 1] + E);
        }
        for (
            let y = 0;
            y < i.virtual.slidesBefore + i.virtual.slidesAfter;
            y += 1
        )
    ...
    if (
        ...
        u <= t.maxBackfaceHiddenSlides
            ? y || i.el.classList.add(S)
            : y && i.el.classList.remove(S);
    }
}
function Ye(i) {
    const e = this,
...
function Ue() {
    ...
    a &&
        ...
        l
            ...
            : ((c = ke(a, `.${t.slideClass}, swiper-slide`)[0]),
              t.loop && !c && (c = e[0]),
              c && c.classList.add(t.slideNextClass),
...
function Je(i) {
    ...
    for (let r = 0; r < e.length; r += 1)
        typeof e[r + 1] != "undefined"
            ...
            : s >= e[r] && (n = r);
    return (
        t.normalizeSlideIndex && (n < 0 || typeof n == "undefined") && (n = 0),
        n
    );
}
function Qe(i) {
    ...
    if ((typeof a == "undefined" && (a = Je(e)), s.indexOf(t) >= 0))
        d = s.indexOf(t);
    else {
    ...
    let p;
    if (e.virtual && n.virtual.enabled && n.loop) p = c(a);
    else if (u) {
...
function it(i, e) {
    ...
    t.isHorizontal() ? (o = s ? -i : i) : (a = i),
        ...
        n.cssMode
            ? (r[t.isHorizontal() ? "scrollLeft" : "scrollTop"] =
                  t.isHorizontal() ? -o : -a)
            : n.virtualTranslate ||
              (t.isHorizontal()
...
function ft(i, e, t, s, n) {
    ...
    if (
        ...
        return (
            ...
            x !== "reset" && (r.transitionStart(t, x), r.transitionEnd(t, x)),
            !1
        );
    if (o.cssMode) {
        ...
        e === 0
            ...
            : r.animating ||
              ...
              r.onSlideToWrapperTransitionEnd ||
                  (r.onSlideToWrapperTransitionEnd = function (v) {
                      !r ||
                          r.destroyed ||
                          (v.target === this &&
                              (r.wrapperEl.removeEventListener(
            ...
            e.centeredSlides
                ? n < i.loopedSlides - s / 2 ||
                  n > i.slides.length - i.loopedSlides + s / 2
                    ? (i.loopFix(),
                      (n = i.getSlideIndex(
                          O(t, `${l}[data-swiper-slide-index="${r}"]`)[0],
                      )),
                      q(() => {
                          i.slideTo(n);
                      }))
...
function St(i) {
    ...
    const n = () => {
        ...
        d = (c) => {
            for (let u = 0; u < c; u += 1) {
                const p = e.isElement
                    ? X("swiper-slide", [t.slideBlankClass])
                    : X("div", [t.slideClass, t.slideBlankClass]);
                e.slidesEl.append(p);
            }
        };
    if (o) {
...
function Tt(i) {
    ...
    typeof r == "undefined"
        ? (r = a.getSlideIndex(
              d.filter((b) => b.classList.contains(f.slideActiveClass))[0],
          ))
        : (P = r);
    const M = s === "next" || !s,
        V = s === "prev" || !s;
    ...
    const S = x ? Math.ceil(d.length / f.grid.rows) : d.length,
        E =
            (x ? d[r].column : r) +
            (m && typeof n == "undefined" ? -w / 2 + 0.5 : 0);
    if (E < h) {
        I = Math.max(h - E, T);
    ...
    if (
        ...
        f.slidesPerView === "auto"
            ? a.updateSlides()
            : x &&
              ((g.length > 0 && V) || (v.length > 0 && M)) &&
              a.slides.forEach((b, C) => {
            ...
            ? a.controller.control.forEach((C) => {
                  !C.destroyed &&
                      ...
                      C.loopFix(
                          j(W({}, b), {
                              slideTo:
                                  C.params.slidesPerView === f.slidesPerView
                                      ? t
                                      : !1,
                          }),
                      );
...
function It(i) {
    ...
    a.matches(n.focusableElements) &&
        ((w = !1), a.nodeName === "SELECT" && (n.isTouched = !1)),
        t.activeElement &&
...
function Ct(i) {
    ...
    if (typeof s.isScrolling == "undefined") {
        ...
        (t.isVertical() && r.currentX === r.startX)
            ? (s.isScrolling = !1)
            : p * p + f * f >= 25 &&
              ((M = (Math.atan2(Math.abs(f), Math.abs(p)) * 180) / Math.PI),
    ...
    n.oneWayMovement &&
        ((m = Math.abs(m) * (l ? 1 : -1)), (w = Math.abs(w) * (l ? 1 : -1))),
        (r.diff = m),
        (m *= n.touchRatio),
        l && ((m = -m), (w = -w));
              ...
              s.currentTranslate > t.minTranslate() &&
                  ...
                  n.resistance &&
                      (s.currentTranslate =
                          t.minTranslate() -
                          1 +
                          (-t.minTranslate() + s.startTranslate + m) ** P)))
            : m < 0 &&
              (h &&
                  x &&
                  !g &&
              ...
              s.currentTranslate < t.maxTranslate() &&
                  ...
                  n.resistance &&
                      (s.currentTranslate =
                          t.maxTranslate() +
                          1 -
                          (t.maxTranslate() - s.startTranslate - m) ** P))),
...
function Lt(i) {
    ...
    for (
        let v = 0;
        v < d.length;
        v += v < l.slidesPerGroupSkip ? 1 : l.slidesPerGroup
    ) {
        const P = v < l.slidesPerGroupSkip - 1 ? 1 : l.slidesPerGroup;
        typeof d[v + P] != "undefined"
            ? f >= d[v] && f < d[v + P] && ((m = v), (w = d[v + P] - d[v]))
            : f >= d[v] && ((m = v), (w = d[d.length - 1] - d[d.length - 2]));
    }
    let T = null,
        h = null;
    l.rewind &&
    ...
    if (p > l.longSwipesMs) {
        ...
        e.swipeDirection === "next" &&
            (x >= l.longSwipesRatio
                ? e.slideTo(l.rewind && e.isEnd ? T : m + g)
                : e.slideTo(m)),
            e.swipeDirection === "prev" &&
                (x > 1 - l.longSwipesRatio
                    ? e.slideTo(m + g)
                    : h !== null && x < 0 && Math.abs(x) > l.longSwipesRatio
                      ? e.slideTo(h)
                      : e.slideTo(m));
    } else {
        if (!l.shortSwipes) {
...
class G {
    constructor() {
        let e, t;
        for (const s = arguments.length, n = new Array(s), r = 0; r < s; r++)
            n[r] = arguments[r];
        n.length === 1 &&
        n[0].constructor &&
    ...
    slidesPerViewDynamic(e, t) {
        ...
        if (n.centeredSlides) {
            ...
            for (let f = d + 1; f < r.length; f += 1)
                r[f] &&
                    !p &&
                    ((u += r[f].swiperSlideSize), (c += 1), u > a && (p = !0));
        ...
        return (
            ...
            e === n ||
                ...
                (s.el.classList.remove(
                    `${s.params.containerModifierClass}${n}`,
                ),
            ...
            e.isElement && f.push(...O(e.hostEl, n)),
                ...
                d.forEach((m, w) => {
                    ...
                    e.params.slidesPerGroup > 1 &&
                        ...
                        (T += Math.ceil(w / 2) - c * (u.length - 1)),
                        (T = Math.min(Math.max(T, -1), 1)),
                        m
                            .querySelectorAll(
                                `${n}, [data-swiper-parallax-rotate]`,
                            )
                            .forEach((h) => {
                                r(h, T);
                            });
        ...
        o = function (a) {
            ...
            e.isElement && u.push(...c.querySelectorAll(n)),
                u.forEach((p) => {
                    let f =
                        parseInt(
                            p.getAttribute("data-swiper-parallax-duration"),
                            10,
                        ) || a;
                    a === 0 && (f = 0), (p.style.transitionDuration = `${f}ms`);
                });
        };
    s("beforeInit", () => {
